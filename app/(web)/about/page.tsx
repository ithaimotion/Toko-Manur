...
import { Shield, Heart, Zap, Star, Target, BookOpen, Award, Users, Flame, Activity } from "lucide-react";
...
export default async function AboutPage() {
  ...
  if (!profile) {
    return <div className="pt-20 text-center py-12">Failed to load profile.</div>;
  }
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative rounded-3xl overflow-hidden aspect-[4/3] bg-slate-100">
              <Image
                src={profile.aboutImage || "https://images.unsplash.com/photo-1519689680058-324335c77eba?w=800&h=600&fit=crop"}
